...
from scrubbed_cvae.plot import scatter_cmap
import sys
...
dataset_label = "Train"
### Load Datasets
dataset, _, model = scrubbed_cvae.get.data_and_model(
    config,
...
# z_null = scrubbed_cvae.eval.project_to_null(
